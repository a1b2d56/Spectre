...
data class TokenRequest(
    ...
    @SerialName("scope")       val scope: String      = "api offline_access",
    @SerialName("client_id")   val clientId: String   = "mobile",
    @SerialName("device_type") val deviceType: Int    = 0,
    @SerialName("device_name") val deviceName: String = "Spectre for Bitwarden",
    @SerialName("device_identifier") val deviceIdentifier: String,
    @SerialName("two_factor_token")   val twoFactorToken: String? = null,
    @SerialName("two_factor_provider") val twoFactorProvider: Int? = null,
    @SerialName("two_factor_remember") val twoFactorRemember: Boolean? = null,
)
...
data class TwoFactorErrorResponse(
    @SerialName("TwoFactorProviders2") val providers: Map<String, Map<String, String?>?> = emptyMap(),
...
data class CipherResponse(
    ...
    @SerialName("Type")           val type: Int,   // 1=Login 2=SecureNote 3=Card 4=Identity
    @SerialName("Name")           val name: String,
...
@Serializable
data class SecureNoteResponse(
    @SerialName("Type") val type: Int = 0,
)

@Serializable
data class FieldResponse(
    @SerialName("Type")    val type: Int,    // 0=Text 1=Hidden 2=Boolean 3=Linked
    @SerialName("Name")    val name: String? = null,
...
data class SendResponse(
    @SerialName("Id")             val id: String,
    @SerialName("Type")           val type: Int,    // 0=Text 1=File
    @SerialName("Name")           val name: String,
    @SerialName("Notes")          val notes: String? = null,
...
data class PolicyResponse(
    ...
    @SerialName("Data")           val data: Map<String, kotlinx.serialization.json.JsonElement> = emptyMap(),
    @SerialName("Enabled")        val enabled: Boolean = false,
)

// ── Create / Update Cipher ────────────────────────────────────────────────────

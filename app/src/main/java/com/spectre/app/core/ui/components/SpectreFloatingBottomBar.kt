...
import com.spectre.app.core.ui.components.liquid.InnerShadow
import com.spectre.app.core.ui.components.liquid.innerShadow
import com.spectre.app.core.ui.components.liquid.lens
import com.spectre.app.core.ui.components.liquid.rememberCombinedBackdrop
import com.spectre.app.core.ui.components.liquid.vibrancy
import com.spectre.app.core.ui.components.miuix.animation.DampedDragAnimation
import com.spectre.app.core.ui.components.miuix.animation.InteractiveHighlight
...
fun FloatingBottomBar(
    ...
    val barHeight = if (showLabels) 64.dp else 52.dp
    val pillHeight = if (showLabels) 56.dp else 44.dp
    ...
    val dampedDragAnimation = remember(animationScope, tabsCount, density, isLtr, showLabels) {
        val pressedScaleFloat = if (showLabels) 78f / 56f else 62f / 44f
        DampedDragAnimation(
            ...
            initialScale = 1f,
            pressedScale = pressedScaleFloat,
            canDrag = { offset ->
